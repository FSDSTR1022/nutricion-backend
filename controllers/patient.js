...
// GET PATIENTS
const getAllPatients = async function (req, res, next) {
    const patient = await PatientModel.find().populate('discipline')
    res.json({ patient })
}
...
module.exports = { getAllPatients, getPatientById, createPatient, putPatient, deletePatient }
